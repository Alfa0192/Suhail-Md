...
global.caption = process.env.CAPTION || global.caption || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ Rayan" 
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ Rayan-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • Rayan ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
  ...
  LANG: ( process.env.THEME ||  "RAYAN"  ).toUpperCase(),
